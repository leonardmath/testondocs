...
**Arquivo:** `empreendimento.yml` (NOVO)
...
**Arquivo:** `tanques-detalhado.yml` (NOVO - Muito expandido!)
...
1. `dados-cadastrais.yml` - Busca CNPJ
2. `endereco.yml` - Busca CEP
3. `contato.yml` - Validação de contatos
4. `localizacao.yml` - Coordenadas e área
5. `historico.yml` - **NOVO** - Histórico completo
6. `entorno.yml` - **NOVO** - Caracterização entorno
7. `empreendimento.yml` - **NOVO** - Infraestrutura detalhada
8. `tanques-detalhado.yml` - **NOVO** - Sistema completo de tanques
9. `bombas.yml` - **NOVO** - Bombas e linhas
...
1. ✅ **Copiar blocos** para `/opt/stackdevops/src/docassemble/docassemble/relatorios/blocks/`
